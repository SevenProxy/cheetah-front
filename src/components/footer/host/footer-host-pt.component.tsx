...
const FooterHostPtComponent = (): JSX.Element => {
  return (
    <footer className="bg-white dark:bg-zinc-800">
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                <div>
                    <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Contatos</h3>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="https://discord.gg/bTxUSkysqG" className="hover:underline">Discord Server</a>
                        </li>
                        <li className="mb-4">
                            <a href="/" className="hover:underline">Outros</a>
                        </li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Empresa</h3>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-4">
                        ...
                        <li className="mb-4">
                            <a href="/" className="hover:underline">Cheetah</a>
                        </li>
                    </ul>
                </div>
            ...
            <div className="text-center">
                <a href="#" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img src="/images/host/logo-cypher.png" className="h-6 mr-3 sm:h-9 rounded-full" alt="Cypher Logo" />
                    Cypher Cloud    
                </a>
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023-2024 Chyper Cloud. Todos os direitos reservados. Construído com <a href="/" className="text-purple-600 hover:underline dark:text-purple-500">Cheetah Solutions</a>
                </span>
                <ul className="flex justify-center mt-5 space-x-5">
                    <li>
                        <a href="https://www.instagram.com/cypher_hosting/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://github.com/cheetahsolutions" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
...
export default FooterHostPtComponent;